...
export const staticImageConfig = {
  ...
  accessories: [
    ...
    { name: "interior_8", defaultTitle: "คอลโซล" },
    { name: "interior_7", defaultTitle: "จอไมล์" },
    { name: "interior_9", defaultTitle: "วิทยุ" },
    { name: "interior_5", defaultTitle: "กล้องหน้ารถ" },
    { name: "interior_11", defaultTitle: "ฟิล์ม" },
    { name: "interior_spare_tire", defaultTitle: "ยางอะไหล่" },
    { name: "interior_wheels_2", defaultTitle: "ล้อหน้าด้านขวา" },
    { name: "interior_wheels_1", defaultTitle: "ล้อหน้าด้านซ้าย" },
    { name: "interior_wheels_4", defaultTitle: "ล้อหลังด้านขวา" },
    { name: "interior_wheels_3", defaultTitle: "ล้อหลังด้านซ้าย" }
  ],
  inspection: [
