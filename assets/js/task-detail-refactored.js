                                    ...
                                    if (isPlaceholder) {
                                        ...
                                        if (field) {
                                            ...
                                            if (img.dataset.createdDate) {
                                                ...
                                                timestampOverlay.style.cssText = 'position: absolute; bottom: 10px; right: 10px; background-color: transparent; color: white; padding: 5px; border-radius: 3px; z-index: 1000;';
